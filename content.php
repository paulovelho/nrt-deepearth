...
?>
	...
	<div class="deep deep-text">
		...
		<div class="meter-1500up" onclick="select('1500up');">
		...
		<div class="meter-10898down three-third l1" onclick="select('10898down');">
			...
			Cientificamente, a expedição de Cameron foi mais produtiva: 68 novas espécies foram trazidas das profundezas; a maioria bactérias, porém também alguns crustáceos.
